...
<div class=" banner-buying" style="min-height: 140px;">
	<div class=" container" style="padding-bottom: 5%;">
		...
		<div class="row" style="margin-top: 12%;">
			<form action="<?php $_SERVER['PHP_SELF'] ?>" method="get" class="filtter" role="form">
			  ...
			  <div class="form-group col-md-2 col-xs-12" style="padding-left:2px; padding-right:2px; margin-bottom:5px">
				  ...
				  <input type="submit" name="filter" value="Apply" class="btn btn-primary form-control" style="display:block; background:#00d5fa; border-color:#00d5fa" onClick="return empty()" />
			  </div>
