...
class ViaNettSMS
{
	...
	public function SendSMS($MsgSender, $DestinationAddress, $Message)
	{
		...
		$url = "http://trans.softhubtechno.com/api/sendmsg.php?user=fairowner&pass=12345&sender=Fowner&phone=$mobile&text=Your OTP for RoomsOnRent.in is:$otp Only Website having 100 percent brokerage free verified properties&priority=ndnd&stype=normal";
