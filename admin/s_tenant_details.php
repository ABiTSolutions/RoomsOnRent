  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
		...
		<li class="active"><a href="s_tenant_details.php"><i class="icon-check"></i><span>Plan Purchase Tenant</span> </a></li>
    ...
    <div class="container">
      <div class="row">
		...
		<?php
				...
				$qu="SELECT * FROM `tenant_reg` where pd_id='1' || manager LIKE '%[^0-9]%' ORDER BY id DESC";
				$sql = @mysqli_query($connection,$qu);
				while($row=@mysqli_fetch_array($sql))
				{
		?>
					<tr>
					<form action="submit11.php" method="post" enctype="multipart/form-data">
						...
						<td><a href="edit_profile33.php?mobile=<?php echo $row['mobile'] ?>">
						<?php 
						//echo $row['name'] 
						$tname=$row['name'];
						...
						<td>
							...
							<a href="post_property11.php?id=<?php echo $row['id'] ?>" class="btn btn-info">&nbsp Edit &nbsp;</a><br/><br/>
                            <a onClick="javascript: return confirm('Please confirm deletion');" href="delete11.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a>
						</td>
						<input type="hidden" name="id" value="<?php echo $row['id'] ?>" />
					</form>	
					</tr>	
