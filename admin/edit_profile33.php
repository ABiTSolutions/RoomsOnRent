...
<div class="loan_single" style="background:rgba(39, 218, 147, 0.15)">
	...
	<?php
	$mobile=$_GET['mobile'];
	$query="SELECT * FROM `tenant_reg` where mobile = $mobile";
        ...
        <h3><U>Personal info</U></h3><br/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              ...
              <span></span>
			  <a href="s_tenant_details.php" class="btn btn-default">Back</a>
            </div>
          </div>
...
<?php
			...
			if(isset($_POST['update']))
			{
				...
				$reg_u="UPDATE `tenant_reg` SET `name`='$n_name',`email`='$n_email',`address`='$n_add',`photo`='$image',`altno`='$n_altno' WHERE mobile = $mobile";
