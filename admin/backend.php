					...
					if(isset($_POST['create_account']))
					{
								...
								$i=1;
										...
										else
										{
											...
											$query="INSERT INTO `registation`(`id`, `name`, `email`, `mobile`, `flow_id`, `pd_id`, `date`, `manager`, `fromwhere`) VALUES ('','".$uname."','".$email."','".$r_mobile."','".$i."','0','".$date."','".$manager."','Backend')";
...
//
			...
			$rqy1="SELECT p_id FROM `sub_admin` where name = '$m'";
			...
			$p_id=$row1[0];
				...
				$pidd=$p_id.''.$pid.',';
				$reg_u1="UPDATE `sub_admin` SET p_id = '$pidd' WHERE name = '$m'";
