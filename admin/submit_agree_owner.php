...
if(isset($_POST['assign']))
{
	...
	if(preg_match('/\b' . $id . '\b/', $p_id))
	{
		...
		echo "<script>window.location.href='agreeowner.php'</script>";
	}
	else
	{
		$pid=$p_id.''.$id.',';
		...
		$oq="UPDATE `registation` SET `manager`='$manager' WHERE id = '$id' ";
...
if(isset($_POST['uploadagre']))
{
	...
	$astatus=$_POST['sagre'];
	$remark=$_POST['remark'];
	$query="UPDATE `registation` SET `agre`='$targetfolder',`indexii`='$targetfolder1',`recep`='$targetfolder2',`powerofauto`='$targetfolder3' WHERE id = '$id'";
...
if(isset($_POST['submit']))
{
	...
	$query="UPDATE `registation` SET `agre_status`='$astatus',`remark`='$remark',`follow_date`='$follow_date' WHERE id = '$id'";
...
if(isset($_POST['sendstage']))
{
	...
	$qu="SELECT * FROM `registation` where id= $id";
...
\n\n\n
											...
											$date=date("d/m/Y");
											$query="UPDATE `registation` SET `stage`='$sendmm',`stage_date`='$date' where id='$id'";
											$upload=  mysqli_query($connection,$query);
	...
	if($sendmm=='stage2')
	{
											$msg="To get Rs.300discount on Doorstep Registered Rental Agreement. Post you property for no cost now! also get assistance in Tenant Verification. roomsonrent.in \n\nRegards\nTeam RoomsOnRent\n$mmobile";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage5')
	{
											$msg="Tenants prefer to contact Owners with 100% complete ad, It’s request, please go to your RoomsOnRent account and complete your property ad by adding photos/Video by clicking roomsonrent.infor a better response. You can also whatsapp on given number.";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage6')
	{
											$msg="Tenants prefer to contact Owners with 100% complete ad, It’s request, please go to your RoomsOnRent account and  complete your property ad by adding photos/Video for a better response. Agreement and Tenant verification can be done at your doorstep. roomsonrent.in";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage81')
	{
											$msg="No need to visit Registrar office for agreement as 24*7 Doorstep Registered rental agreement service is now available in your city. Send enquiries at roomsonrent.in";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage82')
	{
											$msg="Notary agreements are not valid any more. Registered Rental Agreement and Tenant verification is compulsory as per new rules ofMaharashtra Government. Visit us roomsonrent.in fordoorstep serviceand  avail benefit of  Rs.300 as you are our registered user.";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage83')
	{
											$msg="Registered Rental Agreement now available also on weekends and Government holidays at your doorstep. Hassle free service across Pune at lowest possible cost. Call now to avail this service. roomsonrent.in";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	if($sendmm=='stage9')
	{
											$msg="Dear $oname, Congratulations for your new tenant, and thank you for choosing us to help you in Registered Rental Agreement Process.Kindly Conform the Date, Time & Location for the execution of your Agreement.";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
