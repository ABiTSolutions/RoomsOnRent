...
if(isset($_POST['uploadagre']))
{
	...
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','upload the agreement of tenant id:- $id')";
...
if(isset($_POST['submit']))
{
	...
	$name=$_SESSION['subadminname'];
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','update the agreement status of tenant id:- $id')";
	$in=mysqli_query($connection,$qu);
...
if(isset($_POST['sendstage']))
{
	...
	if($sendmm=='stage45')
	{
											$msg="Dear $tname,\n Notary Rent Agreements are not valid any more. Registered Rental Agreement and Tenant verification is compulsory as per new rules of Maharashtra Government. Visit us for door-step service and avail benefit of Rs.300 if you have purchased our Rs.100/- Plan.Calculate your agreement Cost by Clicking roomsonrent.in/agreement.php\nRegards\n Your Personal Manager\n $mname\n $mmobile\n Team RoomsOnRent";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
	...
	$name=$_SESSION['subadminname'];
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','update the stage of tenant id:- $id')";
	$in=mysqli_query($connection,$qu);
}
