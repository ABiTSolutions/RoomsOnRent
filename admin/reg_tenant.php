  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="reg_tenant.php"><i class="icon-group"></i><span>Registered Tenant</span> </a></li>
    ...
    <div class="container">
      <div class="row">
		...
		<?php
				...
				$qu="SELECT * FROM `tenant_reg` where pd_id='0' && manager='$mang' ORDER BY id DESC ";
		...
		?>
					<tr>
					<form action="submit_tenant_111.php" method="post" enctype="multipart/form-data">
						<td><?php echo $row['date'] ?></td>
						<td><a href="edit_profile2.php?mobile=<?php echo $row['mobile'] ?>">
						<?php 
						//echo $row['name']
						$tname=$row['name'];
						...
						<a onClick="javascript: return confirm('Please remember tenant records');" href="delete_reg_o1.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a></td>
					</form>	
					</tr>	
		<?php		
				}
