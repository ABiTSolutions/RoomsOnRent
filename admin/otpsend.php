...
class ViaNettSMS
{
	...
	public function SendSMS($MsgSender, $DestinationAddress, $Message)
	{
		...
		$url = "http://trans.softhubtechno.com/api/sendmsg.php?user=fairowner&pass=12345&sender=Fowner&phone=$mobile&text=$msg&priority=ndnd&stype=normal";
		
		//$url = "http://sms.vndsms.com/vendorsms/pushsms.aspx?user=pratik&password=pratik&msisdn=91$mobile&sid=SSSERV&msg=$msg&fl=0&gwid=2";
