  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
		...
		<li class="active"><a href="s_reg_owner.php"><i class="icon-user"></i><span>Registered Owner</span> </a> </li>
  ...
  <div class="main-inner">
    <div class="container">
      <div class="row">
        ...
        <tbody>
		<?php
				$qu="SELECT * FROM `registation` where pd_id='0' ORDER BY id DESC";
		...
		?>
					<tr>
					<form action="submit_reg_0.php" method="post" enctype="multipart/form-data">
						...
						<td><a href="edit_profile00.php?mobile=<?php echo $row['mobile'] ?>">
						<?php 
						//echo $row['name'] 
						$tname=$row['name'];
						...
						<a onClick="javascript: return confirm('Please remember owner records');" href="delete_reg.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a></td>
					</form>	
					</tr>	
		<?php		
				}
