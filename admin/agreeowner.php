...
<div class="main">
  <div class="main-inner">
    <div class="container">
      <div class="row">
        <div class="span12">
		<h2>Owner From Agreement Page</h2>
        ...
        <tbody>
		<?php
				$qu="SELECT * FROM `registation` where pd_id='0' && fromwhere='Agreement Page' ORDER BY id DESC";
		...
		?>
					<tr>
					<form action="submit_agree_owner.php" method="post" enctype="multipart/form-data">
