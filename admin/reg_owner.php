    ...
    <div class="container">
      <ul class="mainnav">
	   ...
	   <li><a href="backend.php"><i class="icon-list-alt"></i><span>Post Property</span> </a> </li>
		...
		<li class="active"><a href="reg_owner.php"><i class="icon-user"></i><span>Registered Owner</span> </a> </li>
  ...
  <div class="main-inner">
    <div class="container">
      <div class="row">
        ...
        <tbody>
		<?php
				$mang=$_SESSION['subadminname'];
				$qu="SELECT * FROM `registation` where pd_id='0' && manager='$mang' ORDER BY id DESC";
		...
		?>
					<tr>
					<form action="submit_reg_00.php" method="post" enctype="multipart/form-data">
						<td><?php echo $row['date'] ?></td>
						<td><a href="edit_profile.php?mobile=<?php echo $row['mobile'] ?>">
						<?php 
						//echo $row['name'] 
						$tname=$row['name'];
						...
						<a onClick="javascript: return confirm('Please remember owner records');" href="delete_reg1.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Delete</a></td>
					</form>	
					</tr>	
		<?php		
				}
