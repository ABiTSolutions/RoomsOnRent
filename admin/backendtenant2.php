...
<div class=" banner-buying">
			<div style="position:fixed; z-index:9; right:0; bottom:0px; margin:15px;">
				<a href="<?php echo "super_admin_home.php"; ?>" class="hvr-sweep-to-right more" style="background:#27da93; color:#FFF; font-weight:bold; padding:1em" >Back</a>     
			</div>
	<div class=" container">
					...
					if(isset($_POST['create_account']))
					{
								...
								$i=1;
										...
										if(isset($m))
										{
											...
											echo "<script>window.location.href='backendtenant2.php'</script>";
										}
										else
										{
											//$manager=$_SESSION['subadminname'];
											
											$query="INSERT INTO `tenant_reg`(`id`, `name`, `email`, `mobile`, `flow_id`, `pd_id`, `date`, `fromwhere`) VALUES ('','".$uname."','".$email."','".$r_mobile."','".$i."','0','".$date."','Backend')";
