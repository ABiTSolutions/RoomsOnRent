  ...
  <div class="subnavbar-inner">
    <div class="container">
       <ul class="mainnav">
        ...
        <li class="active"><a href="s_owner_details.php"><i class="icon-check"></i><span>Property Posted Owner</span> </a> </li>
      ...
      <div class="row">
		...
		<?php
				...
				*/	
				...
				$qu="select * from registation, property_details WHERE registation.pd_id= property_details.property_id ORDER BY registation.id DESC ";
		...
		?>
					<tr>
					<form action="submit0.php" method="post" enctype="multipart/form-data">
						...
						<td><a href="edit_profile11.php?mobile=<?php echo $row['mobile'] ?>">
						<?php 
						//echo $row['name'] 
						$tname=$row['name'];
						...
						?></td>
						<td><a href="single.php?id=<?php echo $row['pd_id'] ?>"><?php echo $row['pd_id'] ?></a></td>
						<td>
							<select name="sendmm">
								<option>
						...
						<td>
							<!--<div> <input type="button" class="btn btn-default" id="head" value="Upload" /></div>-->
							<div id="" style="">
						...
						<td>
							...
							<a href="post_property0.php?id=<?php echo $row['pd_id'] ?>" class="btn btn-info">&nbsp Edit &nbsp;</a><br/><br/>
                            <a onClick="javascript: return confirm('Please confirm deletion');" href="delete0.php?id=<?php echo $row['pd_id'] ?>" class="btn btn-danger">Delete</a>
							<br/><br/>
						...
						{
		  ?>
		  <a onClick="javascript: return confirm('Please confirm for inactive');" href="a_status.php?id=<?php echo $row['pd_id'] ?>" class="btn btn-default">Inactive</a>
		  <?php
						}
						...
						{
		  ?>
		  <a onClick="javascript: return confirm('Please confirm for active');" href="aa_status.php?id=<?php echo $row['pd_id'] ?>" class="btn btn-default">Active</a>
		  <?php
						}
		  ?>
