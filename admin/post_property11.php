		...
		<div class="loan-col" style="padding:1em 0 2em 0">
			...
			<div class="loan-col1">
				...
				<div class="sub1">
					...
					<label class="hvr-sweep-to-right re-set"><a onclick="window.location.href='s_tenant_details.php'" style="padding: 11px 15px;">Back</a>
				</div>
			</div>
			<!---->
			</form>
			...
			<?php
				...
				if(isset($_POST['submit']))
				{
					...
					$query="UPDATE `tenant_reg` SET `planc` = $increase WHERE id=$id";
