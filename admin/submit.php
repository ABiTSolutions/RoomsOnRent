...
if(isset($_POST['uploadagre']))
{
	...
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','upload the agreement of property id:- $id')";
...
if(isset($_POST['submit']))
{
	...
	$name=$_SESSION['subadminname'];
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','update the agreement status of property id:- $id')";
	$in=mysqli_query($connection,$qu);
...
if(isset($_POST['sendstage']))
{
	...
	if($sendmm=='stage1')
	{
											...
											Dear $oname,
												...
												We provide one stop solution for property owners across Amravati.\n\n
												...
												RoomsOnRent as a service provider has simplified this process for people who own properties across Amravati i.e. by providing a platform where one can advertise his/her property at absolutely no cost, i.e. it is 100% free, we also market your property on different online platforms other than RoomsOnRent.
												\n
...
We ask for you to sympathetically share photographs on roomsonrent.in to make your property 100% finish and to show signs of improvement reaction. \n
...
Likewise Tenant Verification is currently obligatory, the same number of against social/hostile to national exercises happened in Amravati in the last few years, therefore to keep an appropriate record Police has made Tenant check necessary. \n
...
\n\n\n
	...
	if($sendmm=='stage83')
	{
											$msg="Dear $oname, \n\nRegistered Rental Agreement now available also on weekends and Government holidays at your doorstep. Hassle free service across Amravati at lowest possible cost. Call now to avail this service. roomsonrent.in \n\nRegards\nTeam RoomsOnRent\nYour Personal Manager\n$mname\n$mmobile";
											$_COOKIE['mobile']= $mobile;
											$_COOKIE['msg']=$msg;
											include_once("otpsend.php");
...
\n\n\n
	...
	$name=$_SESSION['subadminname'];
	$date=date("d/m/Y");
	$qu="INSERT INTO `notificationi`(`id`, `name`, `date`, `description`) VALUES ('','$name','$date','update the stage of property id:- $id')";
	$in=mysqli_query($connection,$qu);
}
