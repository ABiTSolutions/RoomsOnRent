...
<div class="container">
	...
	<div class="buy-single-single">
			...
			<div style="position:fixed; z-index:9; right:0; bottom:0px; margin:15px;">
				<a href="<?php if(isset($_SESSION['superadminname'])) echo "s_owner_details.php"; else echo "owner_details.php"; ?>" class="hvr-sweep-to-right more" style="background:#27da93; color:#FFF; font-weight:bold; padding:1em" >Back</a>     
			</div>
	   ...
	   <h4 style="font-size: 1.8em; color: #000; font-family: 'Montserrat-Regular'; padding-bottom:1em; padding-top:18px; text-transform:Uppercase;">Property</h4>
  ...
  <ul class="slides">
    <?php
		...
		$array =  explode(',', $c_images);
							...
							{
	?>
	<li data-thumb="<?php if(empty($item)){ echo "../images/default.jpg"; }else{echo "../".$item;} ?>">
      <img src="<?php if(empty($item)){ echo "../images/default.jpg"; }else{echo "../".$item;} ?>" />
    </li>
	<?php
...
<div class="buy-sin-single">
 <div class="col-sm-4 buy-sin middle-side immediate" style="padding:0 0 0 15px;">
		...
		<div class="single-box" style="width:90%; margin:0 auto;">
			<div class=" col-md-4 buy-sin middle-side immediate">
