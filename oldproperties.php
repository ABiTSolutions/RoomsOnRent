...
<div class=" banner-buying" style="min-height: 140px;">
	<div class=" container">
		...
		<div class="row">
			<form action="filter.php" method="get" style="width:80%; margin:0 auto; padding:7px; background:#27da93" role="form">
			  ...
			  <div class="form-group col-md-2" style="padding-left:2px; padding-right:2px; margin-bottom:5px">
				   ...
				   <input type="text" name="locality" class="form-control" id="skills" size="50" placeholder="Locality" value="" />
			  </div>
			  <div class="form-group col-md-2" style="padding-left:2px; padding-right:2px; margin-bottom:5px">
	...
	<div class="dealer-top">
		<h4>Properties</h4>
			<div class="deal-top-top">
				...
				if(isset($_POST['filter']) || isset($_COOKIE['a_locality']))
				{
						$city=$_POST['city'];
						...
						$a=$_COOKIE['a_locality'];
						$b=$_COOKIE['a_any_hk'];
						$c=$_COOKIE['a_furnish'];
						$d=$_COOKIE['rent'];
						
						echo "<script>alert('$a $b $c $d')</script>";
