        ...
        <h3><U>Personal info</U></h3><br/>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              ...
              <span></span>
			  <a href="owner_dashboard.php" class="btn btn-default">Back</a>
            </div>
          </div>
...
<?php
			...
			if(isset($_POST['update']))
			{
				...
				$reg_u="UPDATE `registation` SET `name`='$n_name',`email`='$n_email',`address`='$n_add',`photo`='$image',`altno`='$n_altno' WHERE name = '$name'";
